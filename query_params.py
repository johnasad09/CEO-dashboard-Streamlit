...
def get_param(key):
    """gets value of a query parameter, using the get method of st.query_params
    returns a default value of None if the key does not exist
...
def set_widget_defaults():
    """
    populates the values of various widgets in the app from the query parameters
    """
